<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrasesInsDelUpd.aspx.cs" Inherits="WebApp02.FrasesInsDelUpd" %>
        ...
        <div class="row mt-4">
            ...
            <div class="col-8">
                <form id="form1" runat="server">
                    ...
                    <asp:HiddenField id="Idfrase" runat="server"/>
                    ...
                    <div class="row mb-4">
                        <div class="col-12 text-center">
                            <h3> 
                                <asp:Label ID="Label1" runat="server" Text="Añadir Frase"></asp:Label>
                            </h3>
                        </div>
                    </div>

                    <!-- LA FRASE A INS/DEL/UPD -->
                    <div class="row mb-4">
                        <div class="col-12">
                            <label for="TextBox1">Frase</label>
